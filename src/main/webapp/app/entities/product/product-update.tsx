  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="reikkeiSoftTestApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Stock Quantity" id="product-stockQuantity" name="stockQuantity" data-cy="stockQuantity" type="text" />
              <ValidatedField label="Category Id" id="product-categoryId" name="categoryId" data-cy="categoryId" type="text" />
