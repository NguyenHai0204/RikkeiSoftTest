            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('productId')}>
                  Product Id <FontAwesomeIcon icon={getSortIconByFieldName('productId')} />
                </th>
                ...
                <th className="hand" onClick={sort('stockQuantity')}>
                  Stock Quantity <FontAwesomeIcon icon={getSortIconByFieldName('stockQuantity')} />
                </th>
                <th className="hand" onClick={sort('categoryId')}>
                  Category Id <FontAwesomeIcon icon={getSortIconByFieldName('categoryId')} />
                </th>
                <th />
              </tr>
            </thead>
